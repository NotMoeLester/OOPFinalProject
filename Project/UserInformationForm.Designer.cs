namespace Project {
    partial class UserInformationForm {
        ...
        private void InitializeComponent() {
            ...
            textBoxFirstName.Size = new Size(197, 16);
            ...
            textBoxMI.Location = new Point(419, 84);
            textBoxMI.Name = "textBoxMI";
            textBoxMI.ReadOnly = true;
            textBoxMI.Size = new Size(39, 16);
            ...
            textBoxPrefixSuffix.Location = new Point(469, 84);
            textBoxPrefixSuffix.Name = "textBoxPrefixSuffix";
            textBoxPrefixSuffix.ReadOnly = true;
            textBoxPrefixSuffix.Size = new Size(77, 16);
            ...
            label4.Location = new Point(295, 106);
            label4.Name = "label4";
            ...
            label5.Location = new Point(426, 107);
            label5.Name = "label5";
            label5.Size = new Size(22, 12);
            label5.TabIndex = 19;
            label5.Text = "M.I.";
            // 
            // label6
            ...
            label6.Location = new Point(472, 108);
            label6.Name = "label6";
            ...
            comboBoxCourseProgram.Items.AddRange(new object[] { "AB in Political Science", "AB in Psychology", "AB in Sociology", "BA in Communication", "Bachelor of Laws (LLB)", "BEEd in Elementary Education", "BPEd in Physical Education", "BS in Accountancy", "BS in Architecture", "BS in Biology", "BS in Business Administration", "BS in Civil Engineering", "BS in Computer Engineering", "BS in Computer Science", "BS in Electrical Engineering", "BS in Electronics Engineering", "BS in Entrepreneurship", "BS in Human Resource Management", "BS in Information Systems", "BS in Information Technology", "BS in Marketing Management", "BS in Mechanical Engineering", "BS in Medical Technology", "BS in Nursing", "BS in Pharmacy", "Juris Doctor (JD)" });
            ...
            comboBoxContactNumber.Location = new Point(2, 1);
            comboBoxContactNumber.MaxDropDownItems = 5;
